...
/// Lets the user attach an existing document to a property file.
class LinkDocumentToPropertyFileDialog extends StatefulWidget {
  const LinkDocumentToPropertyFileDialog({
  ...
  @override
  State<LinkDocumentToPropertyFileDialog> createState() =>
      _LinkDocumentToPropertyFileDialogState();
}

class _LinkDocumentToPropertyFileDialogState
    extends State<LinkDocumentToPropertyFileDialog> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await repository.attachDocumentToPropertyFile(
        propertyFileId: widget.propertyFileId,
